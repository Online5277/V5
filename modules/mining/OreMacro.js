...
class OreMiner extends ModuleBase {
    constructor() {
        ...
        this.addToggle(
            ...
            (value) => {
                ...
                if (!value && (this.state === 'WALK' || (this.state.startsWith('MINE') && this.state !== 'MINE_STRAFE'))) Client.setKey('shift', false);
            },
            'Sneak while mining and following Walk waypoints.',
            true
        );
    ...
    tickWalk(waypoint) {
        ...
        if (nearEdge || this.sneakWhileMining) {
            this.ensureShiftHeld();
            if (!nearEdge || Player.isSneaking()) Keybind.setKeysForStraightLineCoords(x, y, z, false);
        ...
        for (let offset = 0; offset < count; offset++) {
            ...
            if (block) {
                return {
                    ...
                    sneakMine: this.sneakWhileMining,
                };
            }
        }
